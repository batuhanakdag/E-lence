...
exports.run = async(yashinu, message, args) => {
  ...
  if (!args[0] || isNaN(args[0])) return message.reply(`Temizlenecek mesaj miktarını belirtmelisin! (400 Üzeri Yapmamanız Önerilir)`);
  message.delete();
  ...
  message.channel.send(` **\`\`${args[0]}\`\` Adet Mesaj Silindi.**`);message.delete(500);
};
